...
class BluetoothGattCallbackImpl extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_CC254X_SERVICE = UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");// service UUID
    private static final UUID BLUETOOTH_LE_CC254X_CHAR_RW = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb"); //Read
    private static final UUID BLUETOOTH_LE_CC254X_CHAR_W = UUID.fromString("0000ffe2-0000-1000-8000-00805f9b34fb"); //Write
    ...
    private class Cc245XDelegate extends DeviceDelegate {
        ...
        boolean connectCharacteristics(BluetoothGattService gattService) {
            ...
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_CC254X_CHAR_W);
            return true;
        }
    }
